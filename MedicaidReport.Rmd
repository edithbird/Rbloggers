...
Population$StatePopul <- as.numeric(as.character( sub(",", ".", Population$StatePopul)))
Population



```{r}
api.key.install(key="d1f9018c1bee6319d1916a5ac7381aa6aea0c9bb")
library(acs)
acs.lookup(endyear = 2011,table.number = "S2601A")
```
