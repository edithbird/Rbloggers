...
ggplot(allDrugsNoNA,aes(x=Number.of.Prescriptions)) + 
    stat_bin(binwidth=500, geom="text", aes(label=..count..), vjust=-1.5, angle = 90) + ylim(c(0, 400)) +  facet_wrap(~State, ncol = 2) + scale_x_continuous(limits = c(-1000, 6000), breaks = c(-1000, 0, 1000, 2000, 3000, 4000, 5000) ) +
  theme(axis.text.x=element_text(angle=90,hjust=1)) 
