...
VIVITROL <- medicaid %>% filter(Product.Code == "VIVITROL")
ZUBSOLV <- medicaid %>% filter(Product.Code == "ZUBSOLV")
BUNAVAIL <- medicaid %>% filter(Product.Code == "BUNAVAIL")
TREATMENT <- rbind.data.frame(SUBOXONE, METHADONE, NALTREXONE, BUPRENORPHINE, VIVITROL, ZUBSOLV)
dim(TREATMENT)
NALTREXONE
toupper("Targiniq")
